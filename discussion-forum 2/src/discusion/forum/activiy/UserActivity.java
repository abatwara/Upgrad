...
public class UserActivity {
	...
	// instance of questionService class
	public QuestionService questionService;
	// instance of replyService class
	public ReplyService replyService;
	// instance of upvoteService class
	public UpvoteService upvoteService;

	/**
	 * This is a constructor to create all service objects
	 */
	public UserActivity() {
	...
	/**
	 * This method will perform login activity using provided username, password from user
	 * @return User who is logged in if username and passwords are correct else null
	...
	/**
	 * This method will call the createuser of user serivice
	 * after taking all required inputs from user
	 * @throws IOException : will be thrown for any IO issue
	 */
	...
	/**
	 * This is a utility method to sort all the questions based on upvote count
	...
	/**
	 * This method will call the upvoteservice to upvote on the question selected by user
	 * @param user who wants to upvote
	 * @throws NumberFormatException : will be thrown if number is not provided as user input
	 * @throws IOException : will be thrown for any IO issue
	 */
	...
	/**
	 * This method will call the replyservice to reply on the question selected by user
	 * @param user who wants to reply
	 * @throws IOException : will be thrown for any IO issue
	 */
	...
	/**
	 * this method will call questionservice to delete the question selected by user
	...
	/**
	 * This method will call replyservice to dispaly all the replies
	 * @param userActivity : the user's activity history
	...
	/**
	 * This method will call upvoteservice to upvote the reply selected by user
	 * @param user current logged in user
	 * @throws NumberFormatException : will be thrown if number is not provided as user input
	 * @throws IOException : will be thrown for any IO issue
	 */
	...
	/**
	 * This method will call replyserivce to delete the reply selected by user
	 * @param question whose reply has to be deleted
	 * @param userActivity : the user's activity history
	 * @param user : current logged in user
	 * @throws NumberFormatException : will be thrown if number is not provided as user input
	 * @throws IOException : will be thrown for any IO issue
	...
	/**
	 * This method will call the replyserivce to return the reply selected by user
	 * @return reply selected by user
	 * @throws NumberFormatException : will be thrown if number is not provided as user input
	 * @throws IOException : will be thrown for any IO issue
	 */
