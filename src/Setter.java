...
class Setter{
    ...
    private static int getTotalSumOfLines(Line firstLine, Line secondLine) {
        ...
        int firstline_lenght = firstLine.getA() - firstLine.getB();
        if(firstline_lenght<0)
        {
            firstline_lenght = -firstline_lenght;
        }
        int secondline_lenght = secondLine.getA() - secondLine.getB();
        if(secondline_lenght<0)
        {
            secondline_lenght = -secondline_lenght;
        }
        return firstline_lenght+secondline_lenght;
